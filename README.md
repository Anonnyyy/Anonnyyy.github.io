...
- `index.html`：个人作品集首页。
- `projects/three-point-controller/`：三点控制器论文项目页。
- `projects/rcar-humanoid-reaching/`：RCar / 本科毕设项目页。
- `projects/signal-separation-2023/`：电赛项目页。

论文项目页使用常见学术展示结构：标题、资源链接、演示视频、摘要、方法图与实验结果。科学内容与素材来源记录在各项目的 `SOURCE_NOTES.md`。
